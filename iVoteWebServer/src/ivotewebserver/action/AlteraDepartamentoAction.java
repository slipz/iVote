...
public class AlteraDepartamentoAction extends ActionSupport implements SessionAware {
			...
			if(campo.trim().equals("") || info.trim().equals("")){
				...
				switch(campo){
					...
					case "Email":
						tipo = "3";
						break;
					case "Faculdade em que se insere":
						tipo = "4";
						break;
				}
				try {
					String msg = bean.alterarDep(nome, tipo, info);
