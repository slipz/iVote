	      ...
	      <div class="card text-center" style="padding: 3%;">
	        <div class="card-block" style="border-style:solid; border-width: thin; border-color: #000000; background-color: #d3d3d3; border-radius: 3%;">
	          <c:if test="${UserBean.sum > 0}">
		          <h3 class="card-title">idEleicao: <c:out value="${UserBean.resultMap['idE']}"/></h3>
		          <p class="card-text">Numero do CC: <c:out value="${UserBean.resultMap['cc']}"/></p>
		          <p class="card-text">Local de voto: <c:out value="${UserBean.resultMap['local']}"/></p>
		          <p class="card-text">Data: <c:out value="${UserBean.resultMap['data']}"/></p>
		      </c:if>
		      <c:if test="${UserBean.sum == 0 }">
