...
<s:form class="form-signin" action="criar_eleicao">
    <h2 class="form-signin-heading">Criar Eleicao</h2>
    <a class="btn btn-outline-secondary btn-lg" href="<s:url action="goCriaEleicaoNucleoAction"/>" role="button">Nucleo de Estudantes</a>
    <a class="btn btn-outline-secondary btn-lg" href="<s:url action="goCriaEleicaoGeralAction"/>" role="button">Conselho Geral</a>
</s:form>
