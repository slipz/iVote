...
<!-- top navbar end -->
    ...
    <div class="container">
		...
		<div class="col-md-4">
	  	  <h3 style="padding: 3%;">Registo de voto</h3>
	      <div class="card text-center" style="padding: 3%;">
	        <div class="card-block" style="border-style:solid; border-width: thin; border-color: #000000; background-color: #d3d3d3; border-radius: 3%;">
	          <c:if test="${AdminBean.sum > 0}">
		          <h3 class="card-title">idEleicao: <c:out value="${AdminBean.resultMap['idE']}"/></h3>
		          <p class="card-text">Numero do CC: <c:out value="${AdminBean.resultMap['cc']}"/></p>
		          <p class="card-text">Local de voto: <c:out value="${AdminBean.resultMap['local']}"/></p>
		          <p class="card-text">Data: <c:out value="${AdminBean.resultMap['data']}"/></p>
		      </c:if>
		      <c:if test="${AdminBean.sum == 0 }">
		    	<h4>Não existe nenhum registo deste eleitor nesta eleicao</h4>
			</c:if> 
	        </div>
	      </div>
	    </div>
