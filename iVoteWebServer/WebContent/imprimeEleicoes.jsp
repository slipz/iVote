...
<!-- top navbar end -->
	 		...
	 		<div class="col-md-3">
			    <div class="card text-center" style="padding: 3%;">
			      <div class="card-block" style="border-style:solid; border-width: thin; border-color: #000000; background-color: #d3d3d3; border-radius: 3%;">
			        ...
			        <a id="<s:property value="#idE"/>" href="<s:url action="goDetalhesEleicaoAction"><s:param name="idEleicao"><s:property value="#idE"/></s:param></s:url>" >Detalhes</a>
			      </div>
			    </div>
			  </div>
		  </c:forEach>
    ...
    <c:if test="${AdminBean.sum == 0 }">
    	<h4>Não existem eleições no Sistema</h4>
    </c:if>
