...
<!-- top navbar end -->
    ...
    <div class="container">
		...
		<s:form class="form-signin" action="adicionar_mesa_voto">
	        <h2 class="form-signin-heading">Adicionar Mesa de Voto a uma Eleicao</h2><br>

	        <s:textfield type="text" name="idEleicao" class="form-control" placeholder="Id da eleicao" required="true"/>
	        	
	        <s:textfield type="text" name="nomedep" class="form-control" placeholder="Nome do departamento onde vai inserir" required="true"/>
