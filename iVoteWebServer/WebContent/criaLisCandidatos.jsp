...
<!-- top navbar end -->
    ...
    <div class="container">
	   ...
	   <s:form class="form-signin" action="criar_lista_candid">
	        <h2 class="form-signin-heading">Criar Lista de Candidatos</h2><br>

	        <s:textfield type="text" name="idEleicao" class="form-control" placeholder="Id da eleicao" required="true"/>
	        	
	        <s:textfield type="text" name="nome" class="form-control" placeholder="Nome da lista" required="true"/>
	        
	        <s:radio labelposition="inline" list="{'Estudantes', 'Funcionarios', 'Docentes'}" name="tipoLista"/>
	        
	        <s:textfield type="text" name="nomePres" class="form-control" placeholder="Nome do presidente" required="true"/>
	        
	        <s:textfield type="text" name="nomeVice" class="form-control" placeholder="Nome do vice-presidente" required="true"/>
