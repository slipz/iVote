...
<!-- top navbar end -->
    ...
    <div class="container">
		...
		<s:form class="form-signin" action="registoVoto">
	        <h2 class="form-signin-heading">Ver o local de voto de um eleitor</h2><br>
	        <br>
	        <p>CC do eleitor</p>
	        <s:textfield type="text" name="cc" class="form-control" placeholder="CC eleitor" required="true"/>
			<p>Id da eleicao</p>
	        <s:textfield type="text" name="ide" class="form-control" placeholder="Id eleicao" required="true"/>
	        
	        <s:submit cssClass="btn btn-outline-secondary btn-lg" type="submit" value="Ver"/>
	     </s:form>
