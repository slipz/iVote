...
<!-- top navbar end -->
    ...
    <div class="container">
	   ...
	   <s:form class="form-signin" action="criar_eleicao_nucleo">
	        <h2 class="form-signin-heading">Criar Eleicao Nucleo</h2><br>
	        
	        <s:textfield type="text" name="nomeDep" class="form-control" placeholder="Nome do Departamento" required="true"/>
	
	        <s:textfield type="text" name="idEleicao" class="form-control" placeholder="Id para a eleicao" required="true"/>
	        	
	        <s:textfield type="text" name="titulo" class="form-control" placeholder="Titulo da eleicao" required="true"/>
	        
	        <s:textarea	 type="text" name="descricao" cols="40" rows="10" class="form-control" placeholder="Descricao da eleicao" required="true"/>
 
	        <s:textfield type="text" name="dataI" cssClass="form-control" placeholder="Data de inicio (DD/MM/AAAA HH:MM)" required="true"/>
	        
	        <s:textfield type="text" name="dataF" cssClass="form-control" placeholder="Data de fim (DD/MM/AAAA HH:MM)" required="true"/>
	        
	        <s:submit cssClass="btn btn-outline-secondary btn-lg" type="submit" value="Criar"/>
	     </s:form>
	<br><br><br><br>
