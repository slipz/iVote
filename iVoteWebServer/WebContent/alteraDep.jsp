...
<!-- top navbar end -->
    ...
    <div class="container">
		...
		<s:form class="form-signin" action="alterar_departamento">
	        <h2 class="form-signin-heading">Alterar informacoes de um departamento</h2><br>
	        <br>
			...
			<s:select tooltip="Selecione o campo e insira a nova informação" label="Escolha o campo a alterar:" list="{'Morada', 'Contacto telefonico', 'Email', 'Faculdade em que se insere'}" name="campo" emptyOption="false" />
