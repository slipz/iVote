...
<!-- top navbar end -->
    ...
    <div class="container">
		...
		<s:form class="form-signin" action="alterar_eleicao">
	        <h2 class="form-signin-heading">Alterar informacoes de uma eleicao</h2><br>
	        <p>ID da eleicao a alterar: </p>
	        <s:textfield type="text" name="idEleicao" class="form-control" placeholder="ID da Eleicao" required="true"/>
			
			<s:select tooltip="Se pretender alterar a data, mantenha o formato DD/MM/AAAA HH:MM:" label="Escolha o campo a alterar:" list="{'Titulo', 'Descricao', 'Data de inicio', 'Data de fim'}" name="campo" emptyOption="false"/>
			
	        <s:textfield type="text" name="info" class="form-control" placeholder="Nova informacao" required="true"/>
	        
	        <s:submit cssClass="btn btn-outline-secondary btn-lg" type="submit" value="Alterar"/>
	     </s:form>
	<br>
    <br>
    <br>
