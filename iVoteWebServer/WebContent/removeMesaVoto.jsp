...
<!-- top navbar end -->
    ...
    <div class="container">
		...
		<s:form class="form-signin" action="remover_mesa_voto">
	        <h2 class="form-signin-heading">Remover Mesa de Voto de uma Eleicao</h2><br>

	        <s:textfield type="text" name="idEleicao" class="form-control" placeholder="Id da eleicao" required="true"/>
	        	
	        <s:textfield type="text" name="nomedep" class="form-control" placeholder="Nome do departamento onde vai remover" required="true"/>
	        
	        <s:submit cssClass="btn btn-outline-secondary btn-lg" type="submit" value="Remover"/>
	     </s:form>
