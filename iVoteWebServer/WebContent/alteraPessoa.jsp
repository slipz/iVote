...
<!-- top navbar end -->
    ...
    <div class="container">
		...
		<s:form class="form-signin" action="alterar_pessoa">
	        <h2 class="form-signin-heading">Alterar informacoes de um eleitor</h2><br>
	        <br>
	        <p>CC do eleitor:</p>
	        <s:textfield type="text" name="ncc" class="form-control" placeholder="Nome do Departamento" required="true"/>
			
			<s:select tooltip="Selecione o campo e insira a nova informação" label="Escolha o campo a alterar:" list="{'Morada', 'Contacto telefonico', 'Departamento em que se insere', 'Password'}" name="campo" emptyOption="false" />
