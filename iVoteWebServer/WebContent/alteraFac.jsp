...
<!-- top navbar end -->
    ...
    <div class="container">
		...
		<s:form class="form-signin" action="alterar_faculdade">
	        <h2 class="form-signin-heading">Alterar informacoes de um departamento</h2><br>
			<p>Nome da Faculdade:</p>
	        <s:textfield type="text" name="nome" class="form-control" placeholder="Nome da Faculdade" required="true"/>
			
			<s:select tooltip="Selecione o campo e insira a nova informação" label="Escolha o campo a alterar:" list="{'Morada', 'Contacto telefonico', 'Email'}" name="campo" emptyOption="false" />			
