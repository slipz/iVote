...
<!-- top navbar end -->
    ...
    <div class="container">
        ...
        <s:form class="form-signin" action="criar_departamento">
	        <h2 class="form-signin-heading">Criar Departamento</h2>
	        
	        <label for="inputNome" class="sr-only">Nome</label>
	        <s:textfield type="text" name="nome" class="form-control" placeholder="Nome do Departamento" required="true"/>
	
	        <label for="inputText" class="sr-only">Morada</label>
	        <s:textfield type="text" name="morada" class="form-control" placeholder="Morada" required="true"/>
	        	
			<label for="inputText" class="sr-only">Contacto Telefonico</label>
	        <s:textfield type="text" name="ntlf" class="form-control" placeholder="Contacto Telefonico" required="true"/>
	        
			<label for="inputText" class="sr-only">Email</label>
	        <s:textfield type="text" name="email" class="form-control" placeholder="Email" required="true"/>
	        
	        <label for="inputText" class="sr-only">Faculdade</label>
	        <s:textfield type="text" name="nomeFac" class="form-control" placeholder="Nome da Faculdade" required="true"/>
